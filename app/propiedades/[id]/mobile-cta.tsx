    ...
    <div className="fixed bottom-0 inset-x-0 z-40 lg:hidden bg-[#0b1d2c]/92 backdrop-blur-xl border-t border-white/10 shadow-[0_-8px_40px_rgba(0,0,0,0.6)] px-4 py-2 flex items-center gap-3">
      {precio ? (
        <div className="flex-1 min-w-0">
          <p className="font-sans text-[13px] font-[300] text-white/80 leading-none truncate">{precio}</p>
          {precioM2 && (
      ...
      <a
        ...
        className="flex-shrink-0 bg-gold rounded-lg px-8 py-3.5 font-sans text-[11px] font-[700] uppercase tracking-[0.18em] text-navy-deep shadow-[0_4px_20px_rgba(197,168,100,0.4)] active:scale-[0.97] transition-transform"
      >
        Contactar
      </a>
    </div>
